                                    ...
                                    QAction *removeAction)
{
    ...
    menu = topMenu->addMenu(tr("Other"));
    menu->addAction(addProfile(group, "SD 4:3 NTSC", "dv_ntsc"));
    menu->addAction(addProfile(group, "SD 4:3 PAL", "dv_pal"));
    ...
    menu->addAction(addProfile(group, "640x480 4:3 29.97 fps", "square_ntsc"));
    menu->addAction(addProfile(group, "768x576 4:3 25 fps", "square_pal"));
    menu->addAction(addProfile(group, "854x480 16:9 29.97 fps", "square_ntsc_wide"));
    menu->addAction(addProfile(group, "1024x576 16:9 25 fps", "square_pal_wide"));
    menu->addAction(addProfile(group, "HD 1080i 25 fps", "atsc_1080i_50"));
    menu->addAction(addProfile(group, "HD 1080i 29.97 fps", "atsc_1080i_5994"));
